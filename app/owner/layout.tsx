...
import { LayoutDashboard, LineChart, Users, LogOut } from "lucide-react"
    ...
    <div className="flex min-h-screen w-full flex-col bg-[#FAFCFB] lg:flex-row font-sans">
      <aside className="w-full lg:w-64 bg-[#051F20] flex flex-col transition-all">
        <div className="p-8 flex flex-col items-center border-b border-[#163832]">
          ...
          <div className="text-[10px] mt-2 text-[#8EB69B] tracking-widest uppercase font-bold">Panel Owner</div>
        </div>
        
        <nav className="flex-1 p-4 space-y-1">
          <Link href="/owner/dashboard" className="flex items-center gap-3 rounded-lg px-4 py-3 text-white bg-[#163832] transition-all duration-300 group">
          ...
          <Link href="/owner/laporan" className="flex items-center gap-3 rounded-lg px-4 py-3 text-[#8EB69B] hover:bg-[#163832] hover:text-white transition-all duration-300 group">
          ...
          <Link href="/owner/karyawan" className="flex items-center gap-3 rounded-lg px-4 py-3 text-[#8EB69B] hover:bg-[#163832] hover:text-white transition-all duration-300 group">
